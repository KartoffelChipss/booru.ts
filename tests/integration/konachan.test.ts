...
describe('Konachan (integration)', () => {
    const site = new Konachan();

    it('exposes site metadata', () => {
        expect(site.getName()).toBe('Konachan');
        expect(site.getSlug()).toBe('konachan');
        expect(site.getWebsite()).toBe('https://konachan.com');
